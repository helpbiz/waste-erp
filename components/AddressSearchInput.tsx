  ...
  return (
    <div className={`flex gap-2 ${className}`}>
      <input
        ...
        disabled={disabled}
        className="flex-1 min-w-0 px-3 py-2 rounded-lg border-2 border-line text-sm focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus:border-accent disabled:opacity-50"
      />
      <button
        type="button"
        onClick={openSearch}
