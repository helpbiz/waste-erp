...
export const WORKER_CHAPTERS: ChapterData[] = [
    ...
    steps: [
      {
        ...
        body: '폰의 인터넷 브라우저(크롬·사파리)를 열고 주소창에 www.cleanerp.kr 을 입력해 주세요. 회사 관리자가 보내드린 카카오톡의 링크를 누르셔도 됩니다.',
      },
      {
  ...
  /* ─── 14 자주 묻는 질문 ─── */
  {
    ...
    faqs: [
      ...
      { q: '폰을 새것으로 바꿨어요. 다시 설정해야 하나요?', a: '네. 새 폰의 브라우저에서 www.cleanerp.kr로 접속하시고, 같은 직원번호와 비밀번호로 로그인하시면 모든 데이터가 그대로 보입니다. 위치 권한과 알림 권한만 다시 한 번 허용해 주시면 됩니다.' },
