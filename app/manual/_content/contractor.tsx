...
export const CONTRACTOR_CHAPTERS: ChapterData[] = [
  ...
  /* ─── 02 처음 로그인 + 콘솔 둘러보기 ─── */
  {
    ...
    steps: [
      ...
      { title: '아이디·임시 비밀번호로 로그인 후 새 비밀번호로 변경', body: '운영팀이 알려드린 아이디(예: HQ001)와 임시 비밀번호로 처음 로그인하시고, 본인만 아는 새 비밀번호로 변경합니다. 이후 모든 로그인은 새 비밀번호로 하시면 됩니다.' },
      {
        ...
        body: '메뉴는 4그룹으로 정리되어 있습니다 — OVERVIEW(대시보드) · CORE MODULES(민원·안전·건강) · OPERATIONS(근태·💰 급여관리·차량·실적·보고서) · SETTINGS(사용자·대형폐기물·공지). 2026-06-01부터 💰 급여관리가 근태관리 바로 아래로 이동되었습니다.',
        screenshot: (
  ...
  /* ─── 05 근태 관리 ─── */
  {
    ...
    steps: [
      ...
      { title: '마감 해제 기능 — 인건비정산 > 근태마감 탭', body: '인건비정산 메뉴의 "근태마감" 탭에서 개별 근로자 행의 "해제" 버튼을 누르면 해당 근로자의 마감을 취소할 수 있습니다. 수정 후 재마감이 가능하며, 해제 시 사유 입력이 필수이고 감사로그에 자동 기록됩니다.' },
