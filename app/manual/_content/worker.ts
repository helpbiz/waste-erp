...
export const WORKER_CHAPTERS: ChapterData[] = [
  ...
  /* ─── 02 처음 로그인하기 ─── */
  {
    ...
    steps: [
      { title: '주소창에 서비스 주소를 입력합니다', body: '폰의 인터넷 브라우저(크롬·사파리)를 열고 주소창에 wci.helpbiz.kr 을 입력해 주세요. 회사 관리자가 보내드린 카카오톡의 링크를 누르셔도 됩니다.' },
      { title: '직원번호와 임시 비밀번호를 입력합니다', body: '회사 관리자가 알려드린 직원번호(예: EMP001)와 임시 비밀번호를 입력하신 후 로그인 버튼을 눌러 주세요.' },
      { title: '개인정보 수집 동의서를 읽고 동의합니다', body: '처음 로그인하실 때 동의 화면이 나옵니다. 천천히 읽으시고 하단의 동의 버튼을 눌러 주세요. 한 번 동의하시면 다시 묻지 않습니다.' },
      { title: '새 비밀번호로 변경합니다', body: '본인만 알 수 있는 비밀번호로 바꿔 주세요. 영문·숫자 포함 8자 이상을 권장드립니다.' },
  ...
  /* ─── 03 출근 도장 찍기 ─── */
  {
    ...
    steps: [
      { title: '워커앱을 열고 "출퇴근" 탭을 누릅니다', body: '하단 다섯 개 탭 중 가운데 시계 아이콘이 "출퇴근"입니다. 누르시면 오늘 날짜·시각과 함께 출근 화면이 나옵니다.' },
      { title: '위치 권한을 한 번 허용해 주세요', body: '폰이 현재 위치를 가져오기 위해 권한을 묻습니다. "허용"을 한 번 눌러주시면 다음부터는 자동으로 동작합니다. 위치는 ~10m 격자로 처리되어 90일 후 자동 폐기됩니다.' },
      { title: 'GPS 신호가 잡힐 때까지 잠시 기다립니다', body: '"위치 확인 중..."이 표시되다가 "준비 완료"로 바뀝니다. 보통 1~5초가 걸리며, 실내·지하주차장에서는 더 오래 걸릴 수 있습니다.' },
      { title: '출근하기 버튼을 누릅니다', body: '"출근하기" 버튼이 활성화되면 한 번 눌러주세요. 등록 완료 메시지와 함께 출근 시간이 화면에 표시됩니다.' },
  ...
  /* ─── 04 휴가 신청하기 ─── */
  {
    ...
    steps: [
      { title: '"더보기" 탭에서 "휴가신청"을 누릅니다', body: '하단 오른쪽 끝의 "⋯ 더보기" 탭을 누르신 후 "휴가신청"을 선택해 주세요.' },
      { title: '내 잔여 연차를 확인합니다', body: '화면 상단에 올해 부여받은 연차·사용한 연차·남은 연차가 표시됩니다. 신청 전에 확인 부탁드립니다.' },
      ...
      { title: '신청 후 결재 진행을 확인합니다', body: '신청을 누르시면 1차 결재(팀장) → 2차 결재(대표)로 자동 전달됩니다. 휴가 목록에서 "신청 / 결재중 / 결재완료 / 반려" 상태가 실시간으로 표시됩니다.' },
    ],
  ...
  /* ─── 05 안전 - 일일점검 ─── */
  {
    ...
    steps: [
      { title: '"안전" 탭을 누르고 "일일점검"을 선택합니다', body: '하단 탭에서 방패 모양 아이콘을 누르시면 안전 화면이 열립니다. 상단의 "일일점검" 탭을 선택해 주세요.' },
      ...
      { title: '"제출" 버튼을 누릅니다', body: '체크가 끝나면 한 번에 제출됩니다. 제출 시각이 기록되어 안전 입증 자료로 자동 보관됩니다.' },
    ],
  ...
  /* ─── 06 안전 - 아차사고·재해 보고 ─── */
  {
    ...
    steps: [
      ...
      { title: '심각도와 상황을 간단히 적습니다', body: '경미·부상·중상·사망 중 해당 항목을 누르시고, 어떤 일이 있었는지 5자 이상 적어주세요. 발생 위치는 자동으로 현재 위치가 입력됩니다.' },
  ...
  /* ─── 07 TBM 서명 ─── */
  {
    ...
    steps: [
      { title: '"안전" 탭의 "TBM" 탭을 누릅니다', body: '오늘의 TBM 주제와 상세 내용이 표시됩니다. 회사 관리자가 아직 등록하지 않은 경우 "오늘 TBM 미등록"으로 보일 수 있습니다.' },
      { title: 'TBM 내용을 읽습니다', body: '오늘 작업의 주의사항·위험 요인을 천천히 읽어주세요. 이해가 안 되는 부분은 동료·관리자에게 바로 확인 부탁드립니다.' },
      { title: '서명 칸에 손가락으로 서명합니다', body: '화면 아래 흰 박스에 본인 서명을 그려 주세요. 잘못 그렸다면 "지우기" 버튼으로 다시 시작하실 수 있습니다.' },
  ...
  /* ─── 08 SOS 긴급 신고 ─── */
  {
    ...
    steps: [
      { title: '"안전" 탭 상단의 빨간색 "SOS" 버튼을 누릅니다', body: '실수로 누를 일이 거의 없도록 누른 후 "정말 보낼까요?" 한 번 더 묻습니다. "예"를 눌러주세요.' },
  ...
  /* ─── 09 민원 처리하기 ─── */
  {
    ...
    steps: [
      { title: '"민원" 메뉴에서 "내 민원"을 봅니다', body: '"더보기" 탭의 민원 메뉴, 또는 홈 화면의 알림에서 새 민원을 확인하실 수 있습니다. 상태(접수/처리중/완료)별로 정리되어 있습니다.' },
      { title: '민원 상세를 누르고 위치를 확인합니다', body: '민원 카드를 누르시면 시민이 신고한 위치가 지도에 표시됩니다. 주소·신고 사진(있는 경우)·처리 기한이 함께 보입니다.' },
      { title: '현장에 도착하면 "도착" 버튼을 누릅니다', body: '도착 시각과 GPS가 자동 기록되어 회사 관리자에게 전달됩니다. 도착 전후 시간이 처리 KPI로 활용됩니다.' },
  ...
  /* ─── 10 실적 입력 ─── */
  {
    ...
    steps: [
      { title: '"실적" 탭을 누릅니다', body: '하단 탭에서 차트 모양 아이콘이 "실적"입니다. 상단에서 "처리실적" 또는 "반입실적" 중 하나를 선택해 주세요.' },
  ...
  /* ─── 11 내 프로필 관리 ─── */
  {
    ...
    steps: [
      { title: '하단 "더보기"에서 "내 프로필"을 누릅니다', body: '본인의 인적 사항·연락처·계좌 정보가 표시됩니다.' },
  ...
  /* ─── 12 추천경로 (RAPID 기동반 전용) ─── */
  {
    ...
    steps: [
      { title: '"더보기" 탭에서 "추천경로"를 누릅니다', body: '메뉴에 "추천경로"가 보이지 않으면 본인 직책이 기동반(RAPID)이 아닌 경우입니다. 회사 관리자에게 직책 확인 부탁드립니다.' },
      { title: '지도에서 미처리 민원 마커를 봅니다', body: '본인 회사의 미처리 민원이 색상별로 표시됩니다. 마커를 누르시면 민원 제목·유형이 보입니다.' },
