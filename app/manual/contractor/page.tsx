...
import { CONTRACTOR_META, CONTRACTOR_CHAPTERS } from '../_content/contractor';

export const metadata = {
  title: `${CONTRACTOR_META.title} — ${MANUAL_META.title}`,
  description: CONTRACTOR_META.subtitle,
};
    ...
    <main className="manual">
      ...
      <div className="manual-container">
        <header className="manual-page-header">
          ...
          <h1 className="manual-page-title">{CONTRACTOR_META.title}</h1>
          <p className="manual-page-lead">{CONTRACTOR_META.welcome}</p>
        </header>

        {CONTRACTOR_CHAPTERS.map((ch) => (
        ...
        <footer style={{ marginTop: 64, paddingTop: 32, borderTop: '1px solid #e2e8f0', textAlign: 'center', color: '#64748b', fontSize: 14 }}>
          ...
          <p>{CONTRACTOR_META.title} · {MANUAL_META.version} · {MANUAL_META.lastUpdated}</p>
