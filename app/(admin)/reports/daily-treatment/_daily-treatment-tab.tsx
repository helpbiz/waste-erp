        ...
        <article className="bg-white border-t-4 border-double border-slate-700 p-6 print:p-0 print:border-none">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 mb-4">
            {(['GENERAL', 'FOOD', 'RECYCLING', 'WOOD'] as const)
              ...
              .map((s) => (
                <div key={s.category} className="border border-line rounded-md p-3 text-center bg-slate-50">
                  ...
                  <div className="font-mono font-black text-xl text-ink">{(s.totalTon * 1000).toFixed(0)}<span className="text-sm font-bold ml-0.5">kg</span></div>
                </div>
              ))}
            <div className="border border-accent rounded-md p-3 text-center bg-cyan-50">
              ...
              <div className="font-mono font-black text-xl text-accent">{(data.totals.weightTon * 1000).toFixed(0)}<span className="text-sm font-bold ml-0.5">kg</span></div>
            </div>
          </div>
          ...
          <table className="w-full border-collapse text-sm">
            <thead>
              <tr className="bg-sidebar text-white">
                ...
                <th className="px-2 py-2 border border-sidebar w-[15%]">중량(kg)</th>
            ...
            {data.rows.length > 0 && (
              <tfoot>
                <tr className="bg-slate-100 font-extrabold">
                  ...
                  <td className="px-2 py-2 border border-line text-right font-mono">{(data.totals.weightTon * 1000).toFixed(0)}</td>
