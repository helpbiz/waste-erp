...
export async function PATCH(req: Request, { params }: { params: { id: string } }) {
  ...
  await prisma.punchRestriction.update({
    ...
    data: {
      ...
      ...(b.requireLocationCheckIn !== undefined && { requireLocationCheckIn: b.requireLocationCheckIn }),
      ...(b.checkInLat !== undefined && { checkInLat: b.checkInLat }),
      ...(b.checkInLng !== undefined && { checkInLng: b.checkInLng }),
      ...(b.checkInRadiusMeters !== undefined && { checkInRadiusMeters: b.checkInRadiusMeters }),
      ...(b.checkInLocationLabel !== undefined && { checkInLocationLabel: b.checkInLocationLabel }),
      ...(b.requireLocationCheckOut !== undefined && { requireLocationCheckOut: b.requireLocationCheckOut }),
      ...(b.checkOutLat !== undefined && { checkOutLat: b.checkOutLat }),
      ...(b.checkOutLng !== undefined && { checkOutLng: b.checkOutLng }),
      ...(b.checkOutRadiusMeters !== undefined && { checkOutRadiusMeters: b.checkOutRadiusMeters }),
      ...(b.checkOutLocationLabel !== undefined && { checkOutLocationLabel: b.checkOutLocationLabel }),
